...
//     <div className="bg-gradient-to-r from-gray-900 via-gray-550 to-black py-16 px-8">
...
//       <motion.div
//         key={index}
//         className="relative group overflow-hidden rounded-xl shadow-lg bg-gray-800 transform hover:scale-105 transition-transform duration-300"
...
//         {/* Button on Hover */}
//         <div className="absolute inset-x-0 bottom-4 opacity-0 group-hover:opacity-100 flex justify-center transition-opacity duration-300"></div>
//       </motion.div>
//     ))}
//   </div>
//   <style jsx>{`
...
const products = [
  ...
  },
  {
    name: "WARDROBE SENSOR & LIGHTS",
    image: "/product/Mini PIR sensor.jpeg",
    details: "Wardrobe sensors and lights illuminate automatically upon opening, providing convenient and energy-efficient lighting.",
  },
  {
    name: "SENSOR SOLAR LIGHTS",
    image: "/product/Voltage Protector.jpeg",
  ...
  },
  {
    name: "MICROWAVE SENSOR",
    image: "/product/microwave  sensor.jpeg",
    details: "Microwave sensors use radar waves for efficient motion detection.",
  },
];
